  ...
  const aggregatedData: AggregatedDataItem[] = useMemo(() => {
    const filtered: AggregatedData = expenses
      .filter((data: ExpenseByCategorySummary) => {
        // Grab the correct category that is selected
        const matchesCategory =
          selectedCategory === "All" || data.category === selectedCategory;
        // Grab the date from the data
        const dataDate = parseDate(data.date);
        // Grab only the data that is within the date range
        const matchesDate =
          !startDate ||
          !endDate ||
      ...
      .reduce((acc: AggregatedData, data: ExpenseByCategorySummary) => {
        ...
        if (!acc[data.category]) {
            ...
            // Grab the category and add up the amount per category
    ...
    // if any change the aggregated data, it will re-render
